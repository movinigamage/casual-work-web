...
jQuery(window).on("load", function() {
    ...
    }), jQuery(window).on("load resize", function() { $(".customscroll").mCustomScrollbar({ theme: "dark-2", scrollInertia: 300, autoExpandScrollbar: !0, advanced: { autoExpandHorizontalScroll: !0 } }) }), jQuery(document).ready(function() {
        "use strict";
        ...
        window.onload = function() {
            ...
            if (e.length) {
                ...
                $("pre code").each(function(e, t) { hljs.highlightBlock(t) })
            }
        }, $("#filter_input").on("keyup", function() {
            var e = $(this).val().toLowerCase();
            $("#filter_list .fa-hover").filter(function() { $(this).toggle(-1 < $(this).text().toLowerCase().indexOf(e)) })
        ...
        $(window).width();
        $(document).on("touchstart click", function(e) { 0 != $(e.target).parents(".left-side-bar").length || $(e.target).is(".menu-icon, .menu-icon img") || ($(".left-side-bar").removeClass("open"), $(".menu-icon").removeClass("open"), $(".mobile-menu-overlay").removeClass("show")) }), $(window).on("resize", function() {
            $(window).width();
    ...
    function(a) {
        a.fn.vmenuModule = function(e) {
            ...
            }), n.autostart ? t.find("a").each(function() { a(this).parent("li").parent("ul").slideDown(n.Speed, function() { a(this).parent("li").children("a").attr("data-option", "on") }) }) : t.find("a.active").each(function() { a(this).parent("li").parent("ul").slideDown(n.Speed, function() { a(this).parent("li").children("a").attr("data-option", "on"), a(this).parent("li").addClass("show") }) })
        }
