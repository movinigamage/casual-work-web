...
export function StarRatingView({ratingNumber} : {ratingNumber: number}) {

    return (
        <div className="rating">
            <input type="radio" name="rating" id="rating-5" checked={ratingNumber === 5}/>
                <label htmlFor="rating-5" />
                <input type="radio" name="rating" id="rating-4" checked={ratingNumber === 4}/>
                    <label htmlFor="rating-4" />
                    <input type="radio" name="rating" id="rating-3" checked={ratingNumber === 3}/>
                        <label htmlFor="rating-3" />
                        <input type="radio" name="rating" id="rating-2" checked={ratingNumber === 2}/>
                            <label htmlFor="rating-2" />
                            <input type="radio" name="rating" id="rating-1" checked={ratingNumber === 1}/>
